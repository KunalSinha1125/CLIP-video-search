...
def main():
    ...
    "Done generating!"
    print
    "Shape of histogram: " + str(hist.shape)
    ...
    for cluster in range(hist_transform.shape[1]):
        print
        "Frame number: %d" % (np.argmin(hist_transform.T[cluster]) * sampling_rate)
